...
export default function ForgotPass(){
    ...
    <View style={styles.container}>
        <Icon name="arrow-left-circle" size={40} color="#FFF" style={{position: 'absolute', left: 25, top: 20}} />    
        ...
        <View style={styles.whiteBox}>
            ...
            <View style={{ borderWidth: 2, borderColor: '#7E57C2', borderRadius: 5, marginHorizontal: 20, flexDirection: 'row'} }>
            <Icon name="mail" size={25} color="#7E57C2" style={{alignSelf:'center', margin: 5}} />
            <TextInput 
