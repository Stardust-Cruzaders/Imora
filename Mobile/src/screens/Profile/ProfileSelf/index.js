            ...
            <ScrollView>
                ...
                <View style={[styles.body, {width: width - 55}]}>
                    <View style={styles.main}>
                        ...
                        <Text style={[styles.bodyTitle, textStyles.font]}>
                            Sobre
                        </Text>
                        <Text style={[styles.bodyText, textStyles.font]}>
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit. Curabitur ornare lacus ac consectetur
                            convallis. Vestibulum ultricies nisl quis interdum
                            laoreet. Aliquam vitae fermentum lectus. Nunc vel
                            varius nisi. Quisque mollis nisl vitae fermentum
                            molestie. Nullam eget aliquam lacus. In porta
                            consequat tincidunt. Nulla vehicula est vel diam
                            fermentum rutrum.
                        </Text>
                        <View>
                            <Div threshold={100} />
