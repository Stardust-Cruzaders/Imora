      ...
      <View style={styles.headerView}>
        <View style={[styles.topBar, {width: width}]}>
          <TouchableOpacity onPress={() => {}}>
            <Icon name={'edit-3'} size={40} color={'#FFF'} />
          </TouchableOpacity>
        </View>
        <View style={styles.profileInfo}>
          ...
          <Text style={[textStyles.font, styles.headerTitle]}>Will Smith</Text>
        </View>
      </View>
      <View style={[styles.body, {width: width - 55}]}>
        <View style={styles.main}>
          ...
          <Text style={[styles.bodyText, textStyles.font]}>
            ...
            eget aliquam lacus. In porta consequat tincidunt. Nulla vehicula est
            vel diam fermentum rutrum.
          </Text>
        </View>
        <Div threshold={100} />
      </View>
